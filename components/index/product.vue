<template>
  <my-slot :title="title" :desc="desc">
    <b-row class="mx-0">
      <b-col lg="4" md="6" sm="12" v-for="(item, ind) of productList" :key="ind" class="wow fadeInDown"
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        title: '产品&解决方案',
        desc: '蚂蚁云致力于帮助客户从信息化到数字化的转型，和政企客户一起构建、优化IT基础架构，同时聚焦云计算、大数据领域，整合上下游厂商资源，集成业界领先的技术、产品和解决方案',
        productList: [
          {
            id: 1,
          ...
          },
          {
            ...
            title: '混合云解决方案',
            desc: '贵阳报废汽车处理中心混合云解决方案深度融合阿里云，结合自身在政企云计算业务技术沉淀，打造出贯通公共云和专有云的解决方案。从业务视角出发，提供基础架构层、数据服务层、应用层、安全能力等多层次的跨云混合。数据服务混合、应用混合和安全能力混合补齐了业界常见的基础架构混合云方案的短板，为用户业务提供全栈混合云能力。'
          },
          {
            id: 3,
