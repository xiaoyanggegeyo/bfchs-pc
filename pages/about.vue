              ...
              <b-col :data-wow-delay="(0.2 * index) + 's'" :offset-md="index === 1 ? 0 : 1" md="6"
                ...
                <b-card-body class="h-100 d-flex justify-content-center align-items-center flex-column text-center">
                  <b-card-text class="w-100">
                    XXXX环保股份有限公司（以下简称“XXXX”）始建于1971年，专业致力于大气污染治理装备的研究开发已有三十余年历史，是全国环保产业骨干龙头企业和我国较大的专业从事烟气除尘、脱硫脱硝装置等大气污染治理设备机电一体化的研发制造基地。公司实力：2014年成为中国环境保护产业协会副会长单位、中国资源综合利用协会技术装备委员会主任委员单位、
                  </b-card-text>
                </b-card-body>
              </b-col>
            </b-row>
...
<script>
  ...
  export default {
    name: 'about',
    components: {Title, Recovery, ServerItem},
    data() {
      return {
        productList: [
          {
